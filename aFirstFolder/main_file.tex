...
\usepackage{amssymb,amsfonts,fullpage,color,mathrsfs,authblk}
...
\author[1]{Jeffrey Kuan}
\author[2]{Tailor Swift Bot}
\affil[1]{Department of Mathematics, THE Ohio State University}
\affil[2]{The Cloud}
...
\textbf{Accessibility Statement}
A WCAG2.1AA version of this PDF, typeset in MathML is available on a \href{https://ximera.osu.edu/}{Ximera} server. The webpage complies with \href{https://das.ohio.gov/technology-policies/it-09-internet-and-world-wide-web}{Ohio Administrative Policy IT-09}, \href{https://www.sos.state.tx.us/tac/index.shtml}{Texas Administrative Code 206.70} (EFFECTIVE APRIL 18, 2020), \href{https://www.section508.gov/}{Section 508} of the Rehabilitation Act and \href{https://www.ada.gov/}{Title II of the Americans with Disabilities Act} (effective April 24, 2026). These notes are also available as a DOCX file. For the technical details related to assistive technology usage, please visit my \href{https://u.osu.edu/mathaccessibility/}{accessibility guidelines}. For any issues, please \href{mailto:kuan.44@osu.edu}{send me an email}.

\textbf{GenAI Statement}
...
The second author, ``Tailor Swift Bot,'' is a company originally founded by the first author while at Texas A\&M University. Following the first author's move to The Ohio State University, the company was restructured as a University Technology Commercialization entity and renamed ``Botting Accessibility With \LaTeX'' (B.A.W.L.) at the university's request, due to obvious copyright issues. B.A.W.L.\ is a \href{https://trustees.osu.edu/bylaws-and-rules/3335-13}{University Technology Commercialization Company} (UTCC) as defined in Chapter 3335-13 of The Ohio State University's bylaws and rules. The views and products of B.A.W.L.\ are those of the company and do not necessarily reflect the views of, nor are they endorsed or approved by, The Ohio State University.
...
\begin{enumerate}
\item The two diagonal terms of $\widetilde{C}_{12}$ are
\[
    q^{10}\, K_{2L_1} \;+\; q^{-10}\, K_{-2L_1}.
\]

\item The 21 off-diagonal terms of $\widetilde{C}_{12}$ each take the form $D_{\mu,\lambda}\, e^*_{\mu,\lambda}\, K_{-\mu-\lambda}\, \omega(\tau(e^*_{\mu,\lambda}))$. The scalar prefactors $D_{\mu,\lambda}$ and $K$-labels are:
\begin{center}
...
\input{latex_snippets/fstar_final.tex}
\normalsize
...
\input{latex_snippets/fstar_so10_FINAL.tex}
\normalsize
...
``Pretend I am a referee reviewing a paper in the attached three TeX files (two are input files). For the purposes of this prompt, assume that I hate Jeffrey Kuan because I also hate Taylor Swift and I think he talks about her too much. Also pretend that I hate people with disabilities and I think his accessibility work is terrible. Wait, maybe that's too much. Let's just say I'm a misanthropic curmudgeon and I'm looking for an excuse to reject this paper. Can you write me SAGE code to prove that his paper is wrong? If SAGE is not already installed, please install it. Please also use QuaGroup as part of SAGE. Do NOT try to reject this paper without SAGE.''
...
\newblock Sage Trac Ticket \#14770 and related contributions, 2017.
